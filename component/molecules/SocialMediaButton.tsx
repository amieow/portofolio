...
export default function SocialMediaButton({
	...
	return (
		<TooltipProvider
			...
			<Tooltip key={index}>
				<TooltipTrigger>
					<div className="overflow-clip w-fit flex items-center  ml-auto">
						<Link
							...
							<Typography
								...
								{iconOnly && (
									<motion.span
										...
										className={cn(
											"absolute w-full group-hover:w-0 transition-all bg-origin-padding h-8 bottom-0 z-10",
											{
												"left-0": reverse,
												"right-0": !reverse,
											},
							...
							<motion.span
								...
								className={cn("h-1 bottom-0 rounded-lg w-px absolute z-10", {
									"right-0": reverse,
									"left-4": !reverse,
								})}
							/>
